...
class SecondHeader(QWidget):
  def __init__(self):
    ...
    self.header_title = QLabel("Drink Menu")
  ...
  def update_header(self, title: str = None, icon_path: str = None, navigate_func: Callable = None, navigate_history: list=None):
    if title:
