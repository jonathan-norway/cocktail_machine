...
class MainView(QWidget):
  def __init__(self, navigate_to: Callable):
    ...
    horizontal_layout_top.addWidget(NavCard("Drink Menu", lambda: navigate_to(GuiViews.DRINK_MENU), "icons/cocktail.png"))
    horizontal_layout_top.addWidget(NavCard("Custom Drink", lambda: navigate_to(GuiViews.CUSTOM_DRINK), "icons/bottles.png"))
    
    horizontal_layout_bottom = QHBoxLayout()
    horizontal_layout_bottom.addWidget(NavCard("Shots", lambda: navigate_to(GuiViews.SHOTS), "icons/shot.png"))
    horizontal_layout_bottom.addWidget(NavCard("Utils", lambda: navigate_to(GuiViews.UTILS), "icons/tools.png"))
